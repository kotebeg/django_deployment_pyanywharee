...
# SECRET_KEY is generated uniquely for each installation via setup.sh
# Falls back to insecure key only for initial setup/testing
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-fallback-run-setup-sh-to-generate-unique-key'
)
